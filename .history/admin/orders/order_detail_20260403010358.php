                ...
                <table class="table table-bordered text-center align-middle">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>
                                    <?php if (!empty($item['image'])): ?>
                                        <img src="../uploads/<?= htmlspecialchars($item['image']) ?>" class="product-image" alt="Product">
                                    <?php else: ?>
                        ...
                        <?php if ($details->num_rows == 0): ?>
                            <tr><td colspan="5" class="text-muted">Không có sản phẩm nào trong đơn hàng.</td></tr>
                        <?php endif; ?>
                    </tbody>
