            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo in_array($currentPage, ['products.php', 'product_add.php', 'product_edit.php']) ? 'active' : ''; ?>"
                        href="/web2_softdrink/admin/products.php">
                        🍹 Sản phẩm
                    </a>
                </li>
                ...
                <!-- Customers -->
                <li class="nav-item">
                    <a class="nav-link <?php echo $currentPage == 'customers_list.php' ? 'active' : ''; ?>"
                        href="/web2_softdrink/admin/customers/customers_list.php">
                        👥 Khách hàng
                    </a>
                </li>
            </ul>
