...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo in_array($currentPage,['categories.php','category_add.php','category_edit.php'])?'active':''; ?>" href="categories.php">
                    📁 Danh mục
                </a>
            </li>
        ...
        <!-- Logout -->
        <a href="../admin/auth/logout.php" class="btn btn-danger">
            🚪 Đăng xuất
        </a>
