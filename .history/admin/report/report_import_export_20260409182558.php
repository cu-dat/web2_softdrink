    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form method="GET" class="row g-2 mb-3" onsubmit="return validateDates()">
                <div class="col-md-4">
                    <input type="date" name="from" id="from_date" value="<?= htmlspecialchars($from) ?>" class="form-control" placeholder="Từ ngày">
                </div>
                <div class="col-md-4">
                    <input type="date" name="to" id="to_date" value="<?= htmlspecialchars($to) ?>" class="form-control" placeholder="Đến ngày">
                </div>
                <div class="col-md-2">
