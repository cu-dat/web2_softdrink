...
VALUES ('admin', 'admin123', 'Administrator', 'admin@softdrink.com');
...
INSERT INTO customers (full_name, email, phone, address, role, status) VALUES
('Cư Đạt', 'cudat@example.com', '0123456789', '123 Lien Khu 16-18, HCM', 'admin', 1),
('Gia Hưng', 'giahung@example.com', '0987654321', '456 Hau Giang, HCM', 'customer', 1),
('Ngọc Sơn', 'ngocson@example.com', '0112233445', '789 Hong Bang, Village', 'customer', 1);
