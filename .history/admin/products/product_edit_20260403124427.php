                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Giá bán sẽ tự động tính = Giá nhập × (1 + lợi nhuận%)</small>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" value="1"
                                    <?= ($product['status'] == 1 && $product['stock'] > 0) ? 'checked' : '' ?>
                                    <?= ($inventory['stock'] == 0) ? 'disabled' : '' ?>>
                                <label class="form-check-label <?= ($product['stock'] == 0) ? 'text-muted' : '' ?>">
                                    Đang bán
                                </label>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" value="0"
                                    <?= ($product['status'] == 0 || $product['stock'] == 0) ? 'checked' : '' ?>>
