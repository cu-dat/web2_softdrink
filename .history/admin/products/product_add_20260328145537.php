...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    (sku, category_id, name, description, price, stock_quantity, unit, profit_margin, image, status) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
");
...
<div class="mb-3">
    <label class="form-label">Đơn vị tính</label>
    <input type="text" name="unit" class="form-control" placeholder="VD: chai, lon">
</div>

<div class="mb-3">
    <label class="form-label">Tỉ lệ lợi nhuận (%)</label>
    <input type="number" name="profit_margin" class="form-control" step="0.1" placeholder="VD: 20">
</div>
